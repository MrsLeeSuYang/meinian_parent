...
public class QiniuUtils {
    ...
    public  static String accessKey = "LybsOUF7PqIy6uhYcrIZA174pH3IpRNrnGVFqw31";
    public  static String secretKey = "IY3wqSBSR_srSKmsdg9CCQsS0jF0FjDkU-NBuDDh";
    public  static String bucket = "cxymeinian";
    ...
    public static void upload2Qiniu(String filePath,String fileName){
        ...
        try {
            ...
            System.out.println("putRe.key" + putRet.key);//打印输出上传后的文件名称
